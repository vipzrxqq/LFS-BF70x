 ...
 * stdint.h
 *
 * (c) Copyright 2009-2014 Analog Devices, Inc.  All rights reserved.
 *
...
#pragma standard_header /* C Standard header */
#endif /* _ADI_COMPILER */
...
#if defined (_ADI_COMPILER) && defined (_MISRA_2004_RULES)
#pragma diag(push)
...
#endif /* defined (_ADI_COMPILER) && defined (_MISRA_2004_RULES) */

#if defined (_ADI_COMPILER) && defined (__BA_SHARC__)
